...
class PPOConfig(BaseConfig):
    ...
    discriminator_pretrain: str = field(
        default=None, metadata={"help": "Path to pretrain model directory for the discriminator model, if available."}
    )
    ...
    discriminator: WorkerConfig = field(
        default_factory=WorkerConfig, metadata={"help": "Configuration for the discriminator's training role."}
    )
    ...
    def __post_init__(self):
        ...
        if self.discriminator.model_args.model_name_or_path is None:
            self.discriminator.model_args.model_name_or_path = self.discriminator_pretrain
        ...
        self.discriminator.training_args.output_dir = self.output_dir
