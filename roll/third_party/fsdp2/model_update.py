...
class FSDP2WeightUpdater:
    ...
    def _colocated_model_update(self):
        ...
        for named_weights in gather_fsdp2_weights(self.model, buffer_size=self._model_update_buffer_size, is_lora=self.is_lora):
    ...
    def _add_lora_to_infer_workers(self):
        ...
        ray.get([worker.add_lora.remote(peft_config) for worker in self.model_update_infer_workers])
